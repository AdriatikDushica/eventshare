...
/***/ function(module, exports, __webpack_require__) {
	...
	var Application = function (_React$Component) {
		...
		function Application(props) {
			...
			_socket2.default.on('setup', function (articles) {
				return _this.setState({ articles: articles });
			});
			_socket2.default.on('new', function (article) {
				return _this.setState({ articles: _this.state.articles.concat([article]) });
			});
			return _this;
		}
	...
	(0, _reactDom.render)(_react2.default.createElement(Application, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = _socket2.default.connect('http://localhost:8081');
